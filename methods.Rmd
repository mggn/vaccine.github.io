---
title: <center> "Exploratory Analysis"
output: 
  html_document:
    toc: true
    toc_float: true
...
**how do we split the index?**

**need to add descriptions and analysis of what the graph is displaying**
**need to figure out how to make the color magma**
