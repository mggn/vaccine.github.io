---
title: <center> Trends in adult vaccination
pagetitle: Trends in adult vaccination
output: 
  html_document:
    code_folding: hide
    toc: true
...
Our working repo is linked [here](https://github.com/mggn/p8105_final_project)
<br>Our website repo is linked [here](https://github.com/mggn/vaccine.github.io)

## Project inspiration

<iframe width="560" height="315" src="https://www.youtube.com/embed/qAWtUu88ug4?start=305" frameborder="0" allow="accelerometer; autoplay=0; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
